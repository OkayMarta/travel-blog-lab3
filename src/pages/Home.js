...
function Home() {
  return (
    <div> {/* Кореневий елемент */} 
      ...
      <section className="blogger-info-section"> {/* className замість class в JSX */}
        <h2>Про мене</h2>
        <div className="blogger-info-content">
          <div className="blogger-text">
            ...
            <p>Мені подобається як <em>природа</em>, так і <em>архітектура</em> – люблю милуватися міськими пейзажами, досліджувати вузькі вулички, але й не проти прогулятися серед гір чи вздовж моря. Де я вже встигла побувати, можна побачити у розділі <a href="/publications">публікацій</a>, а в розділі <a href="/articles">статей</a> я ділюся цікавою інформацією про захопливі місця, які варто відвідати.</p>
